...
CREATE TABLE `af_categorias` (
  ...
  `cate_nombres` varchar(60) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `cate_usrcreacion` varchar(30) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `cate_fcreacion` datetime DEFAULT NULL,
  `cate_estado` enum('A','I') CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`cate_codigo`),
  KEY `cate_linea` (`cate_linea`),
  KEY `cate_usrcreacion` (`cate_usrcreacion`),
  CONSTRAINT `af_categorias_ibfk_1` FOREIGN KEY (`cate_linea`) REFERENCES `af_lineas` (`line_codigo`),
  CONSTRAINT `af_categorias_ibfk_2` FOREIGN KEY (`cate_usrcreacion`) REFERENCES `publica`.`mae_usuarios` (`usua_alias`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of af_categorias
-- ----------------------------
INSERT INTO `af_categorias` VALUES ('001', '001', 'COMPUTADORES', 'ADMIN', '2017-06-28 20:24:10', 'A');
INSERT INTO `af_categorias` VALUES ('002', '001', 'DISPOSITIVOS DE ALMACENAMIENTO', 'ADMIN', '2017-06-28 20:24:51', 'A');
...
CREATE TABLE `af_grupos` (
  ...
  `grup_nombres` varchar(60) NOT NULL,
  `grup_usrcreacion` varchar(30) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `grup_fcreacion` datetime NOT NULL,
  `grup_estado` enum('A','I') CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT 'A',
  PRIMARY KEY (`grup_codigo`),
  KEY `grup_categoria` (`grup_categoria`),
  KEY `grup_usrcreacion` (`grup_usrcreacion`),
  CONSTRAINT `af_grupos_ibfk_1` FOREIGN KEY (`grup_categoria`) REFERENCES `af_categorias` (`cate_codigo`),
  CONSTRAINT `af_grupos_ibfk_2` FOREIGN KEY (`grup_usrcreacion`) REFERENCES `publica`.`mae_usuarios` (`usua_alias`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of af_grupos
-- ----------------------------
INSERT INTO `af_grupos` VALUES ('001', '001', 'UNIDAD LEC Y/O ALMAC. EXTRAIBLE', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('002', '001', 'DISPOSITIVOS DE COMUNICACION', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('003', '001', 'MONITOR', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('004', '001', 'MOTHER BOARD', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('005', '001', 'PROCESADOR', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('006', '001', 'MEMORIA', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('007', '001', 'REGULADOR', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('008', '001', 'DISCO DURO', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('009', '001', 'ACCESORIOS                                                  ', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('010', '001', 'PORTATIL', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('011', '001', 'TODO EN UNO                                                 ', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('012', '001', 'IMPRESORAS', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('013', '001', 'SERVIDORES', 'ADMIN', '2017-07-06 21:29:53', 'A');
INSERT INTO `af_grupos` VALUES ('014', '001', 'SCANNER', 'ADMIN', '2017-07-06 21:32:31', 'A');
...
INSERT INTO `af_lineas` VALUES ('003', 'EQUIPOS DE TECNOLOGIA                                       ', 'EQUIPOS DE TECNOLOGIA                                       ', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-06-18 22:52:38', 'I');
...
INSERT INTO `af_lineas` VALUES ('005', 'EQUIPOS DE TRANSPORTE', 'EQUIPOS DE TRANSPORTE', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:49:27', 'A');
INSERT INTO `af_lineas` VALUES ('006', 'MAQUINARIA', 'MAQUINARIA', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:49:52', 'A');
INSERT INTO `af_lineas` VALUES ('007', 'EQUIPOS ELECTRONICOS', 'EQUIPOS ELECTRONICOS', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:50:27', 'A');
INSERT INTO `af_lineas` VALUES ('008', 'EQUIPOS DE DEPOSITOS', 'EQUIPOS DE DEPOSITOS', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:50:49', 'A');
INSERT INTO `af_lineas` VALUES ('009', 'EQUIPOS DE CLIMATIZACION', 'EQUIPOS DE CLIMATIZACION', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:51:11', 'A');
...
CREATE TABLE `af_marcas` (
  `marc_codigo` char(3) COLLATE latin1_spanish_ci NOT NULL,
  `marc_nombre` varchar(60) COLLATE latin1_spanish_ci NOT NULL,
  `marc_usrcreacion` varchar(30) COLLATE latin1_spanish_ci NOT NULL,
  `marc_fcreacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `marc_estado` enum('A','I') COLLATE latin1_spanish_ci NOT NULL DEFAULT 'A',
  PRIMARY KEY (`marc_codigo`),
  KEY `marc_usrcreacion` (`marc_usrcreacion`),
  CONSTRAINT `af_marcas_ibfk_1` FOREIGN KEY (`marc_usrcreacion`) REFERENCES `publica`.`mae_usuarios` (`usua_alias`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

-- ----------------------------
-- Records of af_marcas
-- ----------------------------
INSERT INTO `af_marcas` VALUES ('001', 'MAXTOR', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('002', 'XEROX', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('003', 'QUEST', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('004', 'CNET', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('005', 'ENCORE', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('006', 'PLANET', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('007', 'LINKSYS', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('008', '3BUMEN', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('009', 'ADVANTEK', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('010', 'CARRIER', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('011', 'CIAC', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('012', 'CONFORTSTAR', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('013', 'RICOH', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('014', 'GENERAL ELECTRIC', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('015', 'MILLER', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('016', 'NEW LIFE', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('017', 'STARLIGHT', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('018', 'YORK', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('019', 'HONEYWELL', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('020', 'GRANDSTREAM', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('021', 'SHARP', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('022', 'TOSHIBA', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('023', 'MITSUBISHI ELECTRONICS', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('024', 'NEC', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('025', 'NOKIA', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('026', 'PANASONIC', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('027', 'SONY', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('028', 'LG', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('029', 'QUANTUM', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('030', 'AOC', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('031', 'QBEX', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('032', 'HP', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('033', 'PACKARD BELL', 'ADMIN', '2017-06-25 11:15:07', 'A');
INSERT INTO `af_marcas` VALUES ('034', 'DELL', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('035', 'IBM', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('036', 'ACER', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('037', 'INTEL', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('038', 'AMD', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('039', 'XEON', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('040', 'WESTERN DIGITAL', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('041', 'CIRIX', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('042', 'IBM', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('043', 'KINGSTON', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('044', 'SAMSUNG', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('045', 'MICRON', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('046', 'TITAN', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('047', 'MARKVISION', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('048', 'GENIUS', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('049', 'LOGITECH', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('050', 'FUJITSU', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('051', 'HITACHI', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('052', 'CREATIVE', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('053', 'MABE', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('054', 'HACEB', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('055', 'WHIRPOOL', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('056', 'CENTRALES', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('057', 'GENERICO', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('058', 'CHEVROLETH', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('059', 'DMG', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('060', 'HANNA MOTORS', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('061', 'DAEWOO', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('062', 'APPLE', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('063', 'AUDI SPARSA', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('064', 'PCCHIPS', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('065', 'PC SMART', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('066', 'CISCO', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('067', 'COMPAQ', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('068', 'A-DATA TECHNOLOGY', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('069', 'QIMONDA AG', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('070', 'INTEL PEARL CREEK', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('071', 'DELL POWER EDGE', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('072', 'INTEL XEON', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('073', 'CANNON', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('074', 'ESYSTOR', 'ADMIN', '2017-06-25 11:15:08', 'A');
INSERT INTO `af_marcas` VALUES ('075', 'SEAGATE', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('076', 'FOXCONN', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('077', 'ASROCK', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('078', 'ELITE GROUP', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('079', 'BIOSTAR', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('080', 'INTEL', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('081', 'MSI', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('082', 'ASUS', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('083', 'PATRIOT', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('084', 'EPSON', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('085', 'ADATA', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('086', 'NEON', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('087', 'HYNIX', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('088', 'SUPRAM', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('089', 'HANNSG', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('090', 'OPTIQUES', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('091', 'MUSTIFF', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('092', 'GENERICO', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('093', 'DEVICE', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('094', 'SOYO', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('095', 'LEXMARK', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('096', 'BELL', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('097', 'DIGITAL CITY', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('098', 'HANNSG', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('099', 'AVANT', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('100', 'GIGABYTE', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('101', 'DESKTAR', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('102', 'VDATA', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('103', 'DEKING', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('104', 'RENDITION', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('105', 'MUSHKIN', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('106', 'OKIDATA ', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('107', 'EMACHINES', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('108', 'KYOCERA', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('109', 'DYNET', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('110', 'BLITZ', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('111', 'VIEW MAGIC', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('112', 'GRAND STREAM', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('113', 'TRENDNET', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('114', 'BOLIDE', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('115', 'POWER WARE', 'ADMIN', '2017-06-25 11:15:09', 'A');
INSERT INTO `af_marcas` VALUES ('116', 'DLINK', 'ADMIN', '2017-06-25 11:15:10', 'A');
INSERT INTO `af_marcas` VALUES ('117', 'CERVI FLEX', 'ADMIN', '2017-06-25 13:56:35', 'A');
INSERT INTO `af_marcas` VALUES ('118', 'HUAWEI PLUS', 'ADMIN', '2017-06-25 15:38:42', 'A');
...
CREATE TABLE `af_presentaciones` (
  `pres_codigo` char(3) COLLATE latin1_spanish_ci NOT NULL,
  `pres_nombre` varchar(60) COLLATE latin1_spanish_ci NOT NULL,
  `pres_abrevia` char(3) COLLATE latin1_spanish_ci NOT NULL,
  `pres_usrcreacion` varchar(30) COLLATE latin1_spanish_ci NOT NULL,
  `pres_fcreacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `pres_estado` enum('A','I') CHARACTER SET latin1 NOT NULL DEFAULT 'A',
  PRIMARY KEY (`pres_codigo`),
  KEY `pres_codigo` (`pres_codigo`),
  KEY `pres_usrcreacion` (`pres_usrcreacion`),
  CONSTRAINT `af_presentaciones_ibfk_1` FOREIGN KEY (`pres_usrcreacion`) REFERENCES `publica`.`mae_usuarios` (`usua_alias`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

-- ----------------------------
-- Records of af_presentaciones
-- ----------------------------
INSERT INTO `af_presentaciones` VALUES ('001', 'UNIDAD', 'UND', 'ADMIN', '2017-06-25 11:24:00', 'A');
INSERT INTO `af_presentaciones` VALUES ('002', 'GIGAHERTZ', 'GHZ', 'ADMIN', '2017-06-25 11:24:00', 'A');
INSERT INTO `af_presentaciones` VALUES ('003', 'GIGAS', 'G', 'ADMIN', '2017-06-25 11:24:00', 'A');
INSERT INTO `af_presentaciones` VALUES ('004', 'TERA', 'T', 'ADMIN', '2017-06-25 11:24:00', 'A');
INSERT INTO `af_presentaciones` VALUES ('005', 'MEGABYTES', 'MB', 'ADMIN', '2017-06-25 11:24:00', 'A');
INSERT INTO `af_presentaciones` VALUES ('006', 'PULGADAS', '\"', 'ADMIN', '2017-06-25 11:24:00', 'A');
INSERT INTO `af_presentaciones` VALUES ('007', 'MEGAHERTZ', 'MHZ', 'ADMIN', '2017-06-25 11:24:00', 'A');
INSERT INTO `af_presentaciones` VALUES ('008', 'BTU PLUS', 'BTU', 'ADMIN', '2017-06-25 11:24:00', 'A');
...
CREATE TABLE `af_subgrupos` (
  `subg_codigo` char(3) COLLATE latin1_spanish_ci NOT NULL,
  `subg_grupo` char(3) COLLATE latin1_spanish_ci NOT NULL,
  `subg_nombres` varchar(60) COLLATE latin1_spanish_ci NOT NULL,
  `subg_usrcreacion` varchar(30) COLLATE latin1_spanish_ci NOT NULL,
  `subg_fcreacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `subg_estado` enum('A','I') COLLATE latin1_spanish_ci NOT NULL DEFAULT 'A',
  PRIMARY KEY (`subg_codigo`),
  KEY `subg_grupo` (`subg_grupo`),
  KEY `subg_usrcreacion` (`subg_usrcreacion`),
  CONSTRAINT `af_subgrupos_ibfk_1` FOREIGN KEY (`subg_grupo`) REFERENCES `af_grupos` (`grup_codigo`),
  CONSTRAINT `af_subgrupos_ibfk_2` FOREIGN KEY (`subg_usrcreacion`) REFERENCES `publica`.`mae_usuarios` (`usua_alias`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

-- ----------------------------
-- Records of af_subgrupos
-- ----------------------------
INSERT INTO `af_subgrupos` VALUES ('001', '008', 'SATA', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('002', '008', 'USB', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('003', '003', 'CRT', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('004', '003', 'LCD', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('005', '005', 'PINES', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('006', '005', 'CONTACTO                                                    ', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('007', '005', 'SLOT', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('008', '006', 'SIMM', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('009', '006', 'DIMM', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('010', '006', 'DDR I', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('011', '006', 'DDR II', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('012', '006', 'USB', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('013', '001', 'CD ROM', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('014', '001', 'CD RW', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('015', '001', 'DVD ROM', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('016', '001', 'DVD RW', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('017', '001', 'CD ROM - CD RW', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('018', '001', 'DVD ROM - DVD RW', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('019', '001', 'TECLADO', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('020', '001', 'MOUSE', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('021', '001', 'ALTAVOCES', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('022', '001', 'WEBCAM', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('023', '001', 'MICROFONO', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('024', '002', 'SWITCH', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('025', '002', 'HUB', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('026', '002', 'ROUTER', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('027', '004', 'AT', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('028', '004', 'MINI AT', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('029', '004', 'XT', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('030', '004', 'ATX                                                         ', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('031', '007', 'DOMESTICO', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('032', '007', 'INDUSTRIAL', 'ADMIN', '2017-07-06 21:42:10', 'A');
INSERT INTO `af_subgrupos` VALUES ('033', '001', 'DISKETTE 3 1/4', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('034', '003', 'CRT2                                                        ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('035', '008', 'IDE                                                         ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('036', '004', 'MINI ATX                                                    ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('037', '006', 'DDR III                                                     ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('038', '003', 'LED                                                         ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('039', '010', 'LAPTOP                                                      ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('040', '010', 'MINI LAPTOP                                                 ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('041', '011', 'SOBRE MESA                                                  ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('042', '012', 'MONOCROMATICA                                               ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('043', '012', 'MULTIFUNCIONAL                                              ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('044', '012', 'IMPRESORA COLOR                                             ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('045', '013', 'TORRE                                                       ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('046', '013', 'PC                                                          ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('047', '002', 'GATEWAY                                                     ', 'ADMIN', '2017-07-06 21:42:11', 'A');
INSERT INTO `af_subgrupos` VALUES ('048', '012', 'MATRIZ DE PUNTO                                             ', 'ADMIN', '2017-07-06 21:42:11', 'A');
...
CREATE TABLE `af_ubicaciones` (
  `ubic_codigo` char(3) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Código de Ubicación',
  `ubic_centrocosto` char(3) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Nit del Centro de Costos',
  `ubic_descripcion` varchar(60) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Descripción de la Ubicación',
  `ubic_sucursal` char(3) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Sucursal donde se encuentra la Ubicación',
  `ubic_usrcreacion` varchar(30) COLLATE latin1_spanish_ci NOT NULL,
  `ubic_fcreacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ubic_estado` enum('A','I') COLLATE latin1_spanish_ci NOT NULL COMMENT 'Estado de la Ubicación',
  PRIMARY KEY (`ubic_codigo`),
  KEY `ubic_centrocosto` (`ubic_centrocosto`),
  KEY `ubic_sucursal` (`ubic_sucursal`),
  KEY `ubic_usrcreacion` (`ubic_usrcreacion`),
  CONSTRAINT `af_ubicaciones_ibfk_1` FOREIGN KEY (`ubic_centrocosto`) REFERENCES `cn_centroscosto` (`ccos_codigo`),
  CONSTRAINT `af_ubicaciones_ibfk_2` FOREIGN KEY (`ubic_sucursal`) REFERENCES `cfg_sucursales` (`sucu_codigo`),
  CONSTRAINT `af_ubicaciones_ibfk_3` FOREIGN KEY (`ubic_usrcreacion`) REFERENCES `publica`.`mae_usuarios` (`usua_alias`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

-- ----------------------------
-- Records of af_ubicaciones
-- ----------------------------
INSERT INTO `af_ubicaciones` VALUES ('001', '001', 'CARTERA', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('002', '001', 'VENTAS', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('003', '001', 'TESORERIA ', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('004', '001', 'ARCHIVO', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('005', '001', 'TALENTO HUMANO', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('006', '001', 'ALMACEN', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('007', '001', 'CONTABILIDAD', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('008', '001', 'MERCADEO', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('009', '001', 'COORDINACION', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('010', '001', 'TALENTO HUMANO ', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('011', '001', 'ATENCION AL CLIENTE', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('012', '001', 'JURIDICA', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('013', '001', 'COORDINACION', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('014', '001', 'GERENCIA', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('015', '001', 'GESTION Y  CONTROL', '001', 'ADMIN', '2017-06-25 12:13:36', 'A');
INSERT INTO `af_ubicaciones` VALUES ('016', '001', 'SISTEMAS', '001', 'ADMIN', '2017-07-12 20:26:11', 'A');
...
-- ----------------------------
INSERT INTO `cfg_consecutivos` VALUES ('001', 'CONSECUTIVO CODIGO DE LINEA', 'CONSECUTIVO CODIGO DE LINEA', '9', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('002', 'CONSECUTIVO DE DEPRECIACION', 'CONSECUTIVO DE DEPRECIACION', '1', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('003', 'CONSECUTIVO DE MARCAS', 'CONSECUTIVO DE MARCAS', '118', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('004', 'CONSECUTIVO DE PRESENTACIONES', 'CONSECUTIVO DE PRESENTACIONES', '8', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('005', 'CONSECUTIVO CENTRO DE COSTOS', 'CONSECUTIVO CENTRO DE COSTOS', '1', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('006', 'CONSECUTIVO DE UBICACIONES', 'CONSECUTIVO DE UBICACIONES', '16', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('007', 'CONSECUTIVO DE SUCURSALES', 'CONSECUTIVO DE SUCURSALES', '1', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('008', 'CONSECUTIVO DE CATEGORIAS', 'CONSECUTIVO DE CATEGORIAS', '2', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('009', 'CONSECUTIVO DE GRUPOS', 'CONSECUTIVO DE GRUPOS', '13', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('010', 'CONSECUTIVO DE SUBGRUPOS', 'CONSECUTIVO DE SUBGRUPOS', '48', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('011', 'CONSECUTIVO CENTRO DE COSTOS', 'CONSECUTIVO CENTRO DE COSTOS', '2', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('012', 'CONSECUTIVO SUCURSALES', 'CONSECUTIVO SUCURSALES', '1', 'N', 'A');
INSERT INTO `cfg_consecutivos` VALUES ('013', 'CONSECUTIVOS ESTABLECIMIENTOS', 'CONSECUTIVOS ESTABLECIMIENTOS', '1', 'N', 'A');
...
CREATE TABLE `cfg_establecimientos` (
  `esta_codigo` char(3) COLLATE latin1_spanish_ci NOT NULL,
  `esta_sociedad` varchar(12) COLLATE latin1_spanish_ci NOT NULL,
  `esta_nit` varchar(12) COLLATE latin1_spanish_ci NOT NULL,
  `esta_nombre` varchar(50) COLLATE latin1_spanish_ci NOT NULL,
  `esta_cuenta` varchar(12) COLLATE latin1_spanish_ci DEFAULT NULL,
  `esta_prefijoactivofijo` char(2) COLLATE latin1_spanish_ci DEFAULT NULL,
  `esta_prefijocredito` char(2) COLLATE latin1_spanish_ci NOT NULL,
  `esta_condesde` int(10) NOT NULL,
  `esta_conhasta` int(10) NOT NULL,
  `esta_rango` int(3) NOT NULL,
  `esta_estado` enum('A','I') COLLATE latin1_spanish_ci NOT NULL DEFAULT 'A',
  PRIMARY KEY (`esta_codigo`),
  KEY `esta_cuenta` (`esta_cuenta`) USING BTREE,
  KEY `esta_codigo` (`esta_codigo`) USING BTREE,
  KEY `cfg_establecimientos_ibfk_3` (`esta_sociedad`),
  KEY `esta_nit` (`esta_nit`),
  CONSTRAINT `cfg_establecimientos_ibfk_2` FOREIGN KEY (`esta_cuenta`) REFERENCES `cn_puc` (`puc_codigo`),
  CONSTRAINT `cfg_establecimientos_ibfk_3` FOREIGN KEY (`esta_sociedad`) REFERENCES `publica`.`mae_empresas` (`empr_nit`) ON UPDATE CASCADE,
  CONSTRAINT `cfg_establecimientos_ibfk_4` FOREIGN KEY (`esta_nit`) REFERENCES `publica`.`mae_personas` (`pers_nit`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `cfg_rolesopciones` VALUES ('ADM', '23', '1', '1', '1', '1', '1', '1', '1', '1');
INSERT INTO `cfg_rolesopciones` VALUES ('ADM', '24', '1', '1', '1', '1', '1', '1', '1', '1');
INSERT INTO `cfg_rolesopciones` VALUES ('ADM', '25', '1', '1', '1', '1', '1', '1', '1', '1');
INSERT INTO `cfg_rolesopciones` VALUES ('ADM', '28', '1', '1', '1', '1', '1', '1', '1', '1');
...
CREATE TABLE `cfg_sucursales` (
  ...
  `sucu_rutafotos` varchar(60) COLLATE latin1_spanish_ci DEFAULT NULL,
  `sucu_rutahuellas` varchar(60) COLLATE latin1_spanish_ci DEFAULT NULL,
  `sucu_resolucionfactura` varchar(60) COLLATE latin1_spanish_ci DEFAULT NULL,
  `sucu_resolucionfecha` date DEFAULT NULL,
  `sucu_desde` int(12) DEFAULT NULL,
  `sucu_hasta` int(12) DEFAULT NULL,
  `sucu_fuente` varchar(6) COLLATE latin1_spanish_ci DEFAULT NULL,
  ...
  CONSTRAINT `cfg_sucursales_ibfk_3` FOREIGN KEY (`sucu_fuente`) REFERENCES `cn_fuentes` (`fuen_codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `cn_centroscosto` (
  ...
  KEY `cn_centroscosto_ibfk_1` (`ccos_usrcreacion`),
  CONSTRAINT `cn_centroscosto_ibfk_1` FOREIGN KEY (`ccos_usrcreacion`) REFERENCES `publica`.`mae_usuarios` (`usua_alias`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of cn_centroscosto
-- ----------------------------
INSERT INTO `cn_centroscosto` VALUES ('001', 'CENTRO DE PRUEBA', 'ADMIN', '2017-06-25 11:45:48', 'A');
INSERT INTO `cn_centroscosto` VALUES ('002', 'CAJA', 'ADMIN', '2017-07-07 21:14:40', 'I');
...
CREATE TABLE `cn_comprobantes` (
  ...
  `comp_fuente` varchar(6) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Tipo de fuente contable',
  ...
  CONSTRAINT `cn_comprobantes_ibfk_4` FOREIGN KEY (`comp_fuente`) REFERENCES `cn_fuentes` (`fuen_codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `cn_comprobantesdetalle` (
  ...
  `deta_fuente` varchar(6) COLLATE latin1_spanish_ci NOT NULL,
  ...
  CONSTRAINT `cn_comprobantesdetalle_ibfk_4` FOREIGN KEY (`deta_sucursal`, `deta_fuente`, `deta_consecutivo`) REFERENCES `cn_comprobantes` (`comp_sucursal`, `comp_fuente`, `comp_consecutivo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
BEGIN
	SELECT 
		...
		esta_nit, esta_nombre, IFNULL(esta_cuenta,'') AS esta_cuenta, IFNULL(puc_nombre,'') AS esta_nombrecuenta,
