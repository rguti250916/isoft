...
`acti_cantpresentacion`  varchar(20) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL ,
...
`acti_responsable`  varchar(12) CHARACTER SET latin1 COLLATE latin1_spanish_ci NULL DEFAULT NULL ,
...
-- ----------------------------
-- Table structure for af_activoscomponentes
-- ----------------------------
DROP TABLE IF EXISTS `af_activoscomponentes`;
CREATE TABLE `af_activoscomponentes` (
`accm_padre`  varchar(12) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL ,
`accm_hijo`  varchar(12) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL ,
`accm_usrcreacion`  varchar(30) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL ,
`accm_fcreacion`  datetime NULL DEFAULT NULL ,
`accm_estado`  enum('I','A') CHARACTER SET latin1 COLLATE latin1_spanish_ci NULL DEFAULT 'A' ,
PRIMARY KEY (`accm_padre`, `accm_hijo`),
FOREIGN KEY (`accm_padre`) REFERENCES `af_activos` (`acti_codigo`) ON DELETE RESTRICT ON UPDATE RESTRICT,
FOREIGN KEY (`accm_hijo`) REFERENCES `af_activos` (`acti_codigo`) ON DELETE RESTRICT ON UPDATE RESTRICT,
FOREIGN KEY (`accm_usrcreacion`) REFERENCES `publica`.`mae_usuarios` (`usua_alias`) ON DELETE RESTRICT ON UPDATE RESTRICT,
INDEX `accm_hijo` (`accm_hijo`) USING BTREE ,
INDEX `accm_usrcreacion` (`accm_usrcreacion`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=latin1 COLLATE=latin1_spanish_ci
...
-- ----------------------------
-- Records of af_activoscomponentes
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `af_categorias` VALUES ('001', '001', 'COMPUTADORES', 'ADMIN', '2017-06-28 20:24:10', 'A'), ('002', '002', 'DISPOSITIVOS DE ALMACENAMIENTO', 'ADMIN', '2017-06-28 20:24:51', 'A');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `af_grupos` VALUES ('001', '001', 'UNIDAD LEC Y/O ALMAC. EXTRAIBLE', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('002', '001', 'DISPOSITIVOS DE COMUNICACION', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('003', '001', 'MONITOR', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('004', '001', 'MOTHER BOARD II', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('005', '001', 'PROCESADOR', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('006', '001', 'MEMORIA', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('007', '001', 'REGULADOR', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('008', '001', 'DISCO DURO', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('009', '001', 'ACCESORIOS                                                  ', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('010', '001', 'PORTATIL', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('011', '001', 'TODO EN UNO                                                 ', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('012', '001', 'IMPRESORAS', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('013', '001', 'SERVIDORES', 'ADMIN', '2017-07-06 21:29:53', 'A'), ('014', '001', 'SCANNER', 'ADMIN', '2017-07-06 21:32:31', 'A'), ('015', '001', 'GRUPO DE PRUEBA', 'ADMIN', '2017-07-24 16:56:30', 'I');
COMMIT;
...
`line_fcreacion`  datetime NOT NULL ,
...
-- ----------------------------
BEGIN;
INSERT INTO `af_lineas` VALUES ('001', 'EQUIPOS DE TECNOLOGIA', 'EQUIPOS DE TECNOLOGIA', '11100502', '86050501', '51107801', '14912201', '01', 'ADMIN', '2017-06-18 22:52:38', 'A'), ('002', 'SERVIDORES                                                  ', 'SERVIDORES                                                  ', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-06-18 22:52:38', 'I'), ('003', 'EQUIPOS DE TECNOLOGIA                                       ', 'EQUIPOS DE TECNOLOGIA                                       ', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-06-18 22:52:38', 'I'), ('004', 'EQUIPOS DE REFRIGERACION                                    ', 'EQUIPOS DE REFRIGERACION                                    ', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-06-18 22:52:38', 'A'), ('005', 'EQUIPOS DE TRANSPORTE', 'EQUIPOS DE TRANSPORTE', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:49:27', 'A'), ('006', 'MAQUINARIA Y EQUIPOS', 'MAQUINARIA Y EQUIPOS', '11100502', '86050501', '51107801', '16059502', '01', 'ADMIN', '2017-07-06 20:49:52', 'A'), ('007', 'EQUIPOS ELECTRONICOS', 'EQUIPOS ELECTRONICOS', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:50:27', 'A'), ('008', 'EQUIPOS DE DEPOSITOS', 'EQUIPOS DE DEPOSITOS', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:50:49', 'A'), ('009', 'EQUIPOS DE CLIMATIZACION', 'EQUIPOS DE CLIMATIZACION', '11100502', '86050501', '51107801', null, '01', 'ADMIN', '2017-07-06 20:51:11', 'A'), ('010', 'TERRENOS', 'TERRENOS', '145925', '146315', '120115', '163510', '01', 'ADMIN', '2017-07-19 09:11:50', 'A');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cfg_consecutivos` VALUES ('001', 'CONSECUTIVO CODIGO DE LINEA', 'CONSECUTIVO CODIGO DE LINEA', '10', 'N', 'A'), ('002', 'CONSECUTIVO DE DEPRECIACION', 'CONSECUTIVO DE DEPRECIACION', '1', 'N', 'A'), ('003', 'CONSECUTIVO DE MARCAS', 'CONSECUTIVO DE MARCAS', '118', 'N', 'A'), ('004', 'CONSECUTIVO DE PRESENTACIONES', 'CONSECUTIVO DE PRESENTACIONES', '8', 'N', 'A'), ('005', 'CONSECUTIVO CENTRO DE COSTOS', 'CONSECUTIVO CENTRO DE COSTOS', '1', 'N', 'A'), ('006', 'CONSECUTIVO DE UBICACIONES', 'CONSECUTIVO DE UBICACIONES', '16', 'N', 'A'), ('007', 'CONSECUTIVO DE SUCURSALES', 'CONSECUTIVO DE SUCURSALES', '1', 'N', 'A'), ('008', 'CONSECUTIVO DE CATEGORIAS', 'CONSECUTIVO DE CATEGORIAS', '2', 'N', 'A'), ('009', 'CONSECUTIVO DE GRUPOS', 'CONSECUTIVO DE GRUPOS', '15', 'N', 'A'), ('010', 'CONSECUTIVO DE SUBGRUPOS', 'CONSECUTIVO DE SUBGRUPOS', '48', 'N', 'A'), ('011', 'CONSECUTIVO CENTRO DE COSTOS', 'CONSECUTIVO CENTRO DE COSTOS', '2', 'N', 'A'), ('012', 'CONSECUTIVO SUCURSALES', 'CONSECUTIVO SUCURSALES', '1', 'N', 'A'), ('013', 'CONSECUTIVO ESTABLECIMIENTOS', 'CONSECUTIVOS ESTABLECIMIENTOS', '1', 'N', 'A'), ('014', 'CONSECUTIVO CONCEPTOS DE INGRESO ACTIVOS FIJO', 'CONSECUTIVO CONCEPTOS DE INGRESO ACTIVOS FIJO', '5', 'N', 'A'), ('015', 'CONSECUTIVO ACTIVO FIJO', 'CONSECUTIVO ACTIVO FIJO', '0', 'N', 'A');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cfg_rolesopciones` VALUES ('AD2', '7', '1', '1', '1', '1', '1', '1', '1', '1'), ('AD2', '8', '1', '1', '1', '1', '0', '1', '1', '1'), ('AD2', '9', '1', '1', '1', '1', '1', '1', '1', '1'), ('AD2', '10', '1', '1', '1', '1', '1', '1', '1', '1'), ('AD2', '14', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADI', '13', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADI', '17', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADI', '19', '0', '1', '0', '0', '1', '1', '1', '1'), ('ADI', '21', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADI', '22', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '3', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '4', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '5', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '7', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '8', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '9', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '10', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '12', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '13', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '14', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '17', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '19', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '21', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '22', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '23', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '24', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '25', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '28', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '29', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '30', '1', '1', '1', '1', '1', '1', '1', '1'), ('ADM', '31', '1', '1', '1', '1', '1', '1', '1', '1'), ('AU2', '17', '0', '1', '0', '0', '0', '1', '0', '1'), ('AUD', '19', '1', '1', '1', '1', '1', '1', '1', '1'), ('AUD', '21', '1', '1', '1', '1', '1', '1', '1', '1'), ('AUD', '22', '0', '0', '0', '0', '0', '0', '1', '0'), ('AUX', '7', '1', '1', '1', '1', '1', '1', '1', '1'), ('AUX', '8', '1', '1', '1', '1', '1', '1', '1', '1'), ('AUX', '9', '1', '1', '1', '1', '1', '1', '1', '1'), ('AUX', '10', '1', '1', '1', '1', '1', '1', '1', '1'), ('AUX', '14', '1', '1', '1', '1', '1', '1', '1', '1'), ('CON', '13', '1', '1', '1', '1', '1', '1', '1', '1'), ('CON', '17', '0', '1', '1', '1', '0', '1', '1', '1'), ('CON', '19', '1', '1', '1', '1', '1', '1', '1', '1'), ('CON', '21', '1', '1', '1', '1', '1', '1', '1', '1'), ('CON', '22', '1', '1', '1', '1', '1', '1', '1', '1'), ('SUP', '12', '0', '0', '0', '0', '0', '0', '1', '0'), ('SUP', '13', '1', '1', '1', '1', '1', '1', '1', '1');
COMMIT;
...
-- ----------------------------
-- Table structure for cn_fuentesdetalle
-- ----------------------------
DROP TABLE IF EXISTS `cn_fuentesdetalle`;
CREATE TABLE `cn_fuentesdetalle` (
...
-- ----------------------------
-- Records of cn_fuentesdetalle
-- ----------------------------
BEGIN;
INSERT INTO `cn_fuentesdetalle` VALUES ('001', 'AF', 'S', '0');
COMMIT;
...
-- ----------------------------
-- Procedure structure for ObtenerActivosFijos
-- ----------------------------
DROP PROCEDURE IF EXISTS `ObtenerActivosFijos`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ObtenerActivosFijos`(PcCodigo VARCHAR(12))
    READS SQL DATA
    DETERMINISTIC
BEGIN
	SELECT 
		acti_codigo,
		ObtenerNombreActivoFijo(acti_codigo) AS acti_nombreactivofijo,
		IFNULL(acti_placa,'') AS acti_placa,
		acti_establecimiento,
		esta_nombre AS acti_nombreestablecimiento,
		acti_subgrupo,
		subg_nombres AS acti_nombresubgrupo,
		grup_nombres AS acti_nombregrupo,
		cate_nombres AS acti_nombrecategoria,
		line_nombres AS acti_nombrelinea,
		acti_marca,
		marc_nombre AS acti_nombremarca,
		acti_presentacion,
		pres_nombre AS acti_nombrepresentacion,
		IFNULL(acti_cantpresentacion,'') AS acti_cantpresentacion,
		pres_abrevia AS acti_abrepresentacion,
		IFNULL(acti_serial,'') AS acti_serial,
		IFNULL(acti_modelo,'') AS acti_modelo,
		acti_ubicacion,
		ubic_descripcion AS acti_nombreubicacion,
		acti_responsable,
		ObtenerNombrePersona(IFNULL(acti_responsable,'')) AS acti_nombreresponsable,
		acti_conceptoingreso,
		ccom_nombre AS acti_nombreconceptoingreso,
		IFNULL(acti_fcompra,'') AS acti_fcompra,
		IFNULL(acti_docusoporte,'') AS acti_docusoporte,
		acti_proveedor,
		ObtenerNombrePersona(IFNULL(acti_proveedor,'')) AS acti_nombreproveedor,
		acti_costo,
		acti_depreciable,
		IFNULL(acti_depreciacion,'') AS acti_depreciacion,
		IFNULL(depr_nombres,'') AS act_nombredepreciacion,
		IFNULL(acti_finiciodepreciacion,'') AS acti_finiciodepreciacion,
		IFNULL(acti_vidautil,0) AS acti_vidautil,
		IFNULL(acti_vidautilrestante,0) AS acti_vidautilrestante,
		IFNULL(acti_valorrescate,0) AS acti_valorrescate,
		IFNULL(acti_depracumulada,0) AS acti_depracumulada,
		acti_usrcreacion,
		acti_fcreacion,
		acti_estado
	FROM
		af_activos
	INNER JOIN
		cfg_establecimientos ON esta_codigo = acti_establecimiento
	INNER JOIN
		af_subgrupos ON subg_codigo = acti_subgrupo
	INNER JOIN
		af_grupos ON grup_codigo = subg_grupo
	INNER JOIN
		af_categorias ON cate_codigo = grup_categoria
	INNER JOIN
		af_lineas ON line_codigo = cate_linea
	INNER JOIN 
		af_marcas ON marc_codigo = acti_marca
	INNER JOIN
		af_presentaciones ON pres_codigo = pres_nombre
	INNER JOIN
		af_ubicaciones ON ubic_codigo = acti_ubicacion
	INNER JOIN
		af_conceptos ON ccom_codigo = acti_conceptoingreso
	LEFT JOIN
		af_depreciaciones ON depr_codigo = acti_depreciacion
	WHERE
		IF(LENGTH(PcCodigo) = 0, acti_codigo <> '', acti_codigo = PcCodigo)
	ORDER BY
		acti_codigo ASC;
END
;;
...
-- ----------------------------
-- Procedure structure for ObtenerCategorias
-- ----------------------------
DROP PROCEDURE IF EXISTS `ObtenerCategorias`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ObtenerCategorias`(PcCodigo CHAR(3), pcLinea CHAR(3))
    READS SQL DATA
    DETERMINISTIC
BEGIN
	SELECT 
		cate_codigo, cate_nombres, cate_linea, line_nombres AS cate_nombrelinea, cate_usrcreacion, cate_fcreacion, cate_estado
	FROM
		af_categorias
	INNER JOIN 
		af_lineas ON line_codigo = cate_linea
	WHERE 
		IF(LENGTH(PcCodigo) = 0, cate_codigo <> '', cate_codigo = PcCodigo) AND IF(LENGTH(pcLinea) = 0, cate_linea <> '', cate_linea = pcLinea)
	ORDER BY 
		cate_codigo ASC;
END
;;
...
-- ----------------------------
-- Procedure structure for ObtenerComponentesPorActivoFijo
-- ----------------------------
DROP PROCEDURE IF EXISTS `ObtenerComponentesPorActivoFijo`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ObtenerComponentesPorActivoFijo`(PcCodigo VARCHAR(12))
    READS SQL DATA
    DETERMINISTIC
BEGIN
	SELECT 
		accm_padre, 
		ObtenerNombreActivoFijo(accm_padre) AS accm_nombreactivo,
		accm_hijo,
		ObtenerNombreActivoFijo(accm_hijo) AS accm_nombrecomponente,
		accm_usrcreacion,
		accm_fcreacion,
		accm_estado
	FROM
		af_activoscomponentes
	WHERE
		IF(LENGTH(PcCodigo) = 0, accm_padre <> '', accm_padre = PcCodigo)
	ORDER BY
		accm_nombreactivo, accm_nombrecomponente ASC;
END
;;
DELIMITER ;
...
-- ----------------------------
-- Procedure structure for ObtenerGrupos
-- ----------------------------
DROP PROCEDURE IF EXISTS `ObtenerGrupos`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ObtenerGrupos`(PcCodigo CHAR(3), pcCategoria CHAR(3))
    READS SQL DATA
    DETERMINISTIC
BEGIN
	SELECT 
		grup_codigo, grup_nombres, grup_categoria, cate_nombres AS grup_nombrecategoria,
		grup_usrcreacion, grup_fcreacion, grup_estado
	FROM
		af_grupos
	INNER JOIN
		af_categorias ON cate_codigo = grup_categoria
	WHERE 
		IF(LENGTH(PcCodigo) = 0, grup_codigo <> '', grup_codigo = PcCodigo) AND
		IF(LENGTH(pcCategoria) = 0, grup_categoria <> '', grup_categoria = pcCategoria)
	ORDER BY
		grup_codigo ASC;
END
;;
...
-- ----------------------------
-- Function structure for GuardarActivoFijo
-- ----------------------------
DROP FUNCTION IF EXISTS `GuardarActivoFijo`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GuardarActivoFijo`(pcCodigo VARCHAR(12), pcPlaca VARCHAR(12), pcEstablecimiento CHAR(3), pcSubGrupo CHAR(3), pcMarca CHAR(3), pcPresentacion CHAR(3), pcCantPres VARCHAR(20), pcSerial VARCHAR(30), pcModelo VARCHAR(30), pcUbicacion CHAR(3), pcResponsable VARCHAR(12), pcConcepto CHAR(3), pcCompra DATE, pcDocuSoporte VARCHAR(60), pcProveedor VARCHAR(12), pcCosto DOUBLE(12,2), pcDepreciable CHAR(1), pcDepreciacion CHAR(2), pcInicioDepreciacion DATE, pcVidaUtil INT(3), pcVidarestante INT(3), pcValorRescate DOUBLE(12,2), pcDepreAcumulada DOUBLE(12,2), pcUsuario VARCHAR(30),pcEstado CHAR(1)) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN	

	DECLARE lnCantidadActivoFijo INT(2) DEFAULT 0;	
	DECLARE lnConsecutivo INT(12) DEFAULT 0;
	DECLARE lcPrefijo CHAR(2) DEFAULT '';
	DECLARE lcConsecutivo CHAR(6) DEFAULT '';
	
	/*************************************************
		VERIFICO SI EL CODIGO DE ACTVIO FIJO EXISTE
	*************************************************/
	SET lnCantidadActivoFijo = (SELECT COUNT(0) FROM af_activos WHERE acti_codigo = pcCodigo);	
	
	IF lnCantidadActivoFijo = 0 THEN

			/*************************************************
				EL ACTIVO FIJO NO EXISTE. ENTONCES TOMO EL CONSECUTIVO
				E INSERTO EL REGISTRO
			*************************************************/

			SET lnConsecutivo = (SELECT ObtenerConsecutivo('015'));

			SET lcConsecutivo = (SELECT LPAD(CONVERT(lnConsecutivo, CHAR(6)),6, '0'));			

			SET lcPrefijo = (SELECT esta_prefijoactivofijo FROM cfg_establecimientos WHERE esta_codigo = pcEstabelcimiento AND esta_estado = 'A');

			IF LENGTH(lcPrefijo) = 0 THEN
					RETURN 0;
			END IF;
		
			SET lcConsecutivo = (SELECT CONCAT(lcPrefijo,"-",lcConsecutivo));			
			
			/*************************************************
				OBTENGO EL PREFIJO DEL ACTIVO
			*************************************************/
			INSERT INTO af_activos (acti_codigo,
									acti_placa,
									acti_establecimiento,
									acti_subgrupo,
									acti_marca,
									acti_presentacion,
									acti_cantpresentacion,
									acti_serial,
									acti_modelo,
									acti_ubicacion,
									acti_responsable,
									...
									acti_depreciable,
									acti_depreciacion,
									acti_finiciodepreciacion,
									acti_vidautil,
									acti_vidautilrestante,
									acti_valorrescate,
									acti_depracumulada,
									acti_usrcreacion,
									acti_fcreacion,
	...
	ELSE
			...
			/*************************************************
				EL ACTIVO EXISTE. ENTONCES ACTUALIZO
			*************************************************/
			UPDATE af_activos
				SET acti_placa = pcPlaca ,
						acti_establecimiento = pcEstablecimiento,
						acti_subgrupo = pcSubGrupo,
						acti_marca = pcMarca,
						acti_presentacion = pcPresentacion,
						acti_cantpresentacion = pcCantPres, 
						acti_serial = pcSerial,
						acti_modelo = pcModelo,
						acti_ubicacion = pcUbicacion,
						acti_responsable = pcResponsable,
						acti_conceptoingreso = pcConcepto,
						acti_fcompra = pcCompra,
						acti_docusoporte = pcDocuSoporte,
						acti_proveedor = pcProveedor,
						acti_costo = pcCosto,
						acti_depreciable = pcDepreciable,
						acti_depreciacion = pcDepreciacion,
						acti_finiciodepreciacion = pcInicioDepreciacion,
						acti_vidautil = pcVidaUtil,
						acti_vidautilrestante = pcVidarestante,
						acti_valorrescate = pcValorRescate,
						acti_depracumulada = pcDepreAcumulada,
						acti_estado = pcEstado
			WHERE
				acti_codigo = pcCodigo;
	END IF;
...
-- ----------------------------
-- Function structure for GuardarCategoria
-- ----------------------------
DROP FUNCTION IF EXISTS `GuardarCategoria`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GuardarCategoria`(pcCodigo CHAR(3), pcLinea CHAR(3), pcNombre VARCHAR(60), pcUsuario VARCHAR(30), pcEstado CHAR(1)) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN	

	DECLARE lnCantidadCategoria INT(2) DEFAULT 0;	
	DECLARE lnConsecutivo INT(12) DEFAULT 0;
	DECLARE lcConsecutivo CHAR(3) DEFAULT '';
	
	/* ************************************************
		VERIFICO SI EL CODIGO DE CATEGORIA RECIBIDO EXISTE
	*************************************************/
	SET lnCantidadCategoria = (SELECT COUNT(0) FROM af_categorias WHERE cate_codigo = pcCodigo);	
	
	IF lnCantidadCategoria = 0 THEN
			/*************************************************
				LA CATEGORIA NO EXISTE. ENTONCES TOMO EL CONSECUTIVO
				E INSERTO EL REGISTRO
			*************************************************/			
			SET lnConsecutivo = (SELECT ObtenerConsecutivo('008'));

			SET lcConsecutivo = (SELECT LPAD(CONVERT(lnConsecutivo, CHAR(3)),3, '0'));

			INSERT INTO af_categorias (cate_codigo,
									cate_linea,
									cate_nombres,
									cate_usrcreacion,
									cate_fcreacion,
	...
	ELSE
			/*************************************************
				LA CATEGORIA EXISTE. ENTONCES ACTUALIZO
			*************************************************/
			UPDATE af_categorias
					SET cate_linea = pcCodigo, 
							cate_nombres = pcNombre,
							cate_estado = pcEstado
			WHERE
				cate_codigo = pcCodigo;
	END IF;
...
-- ----------------------------
-- Function structure for GuardarComponentePorActivoFijo
-- ----------------------------
DROP FUNCTION IF EXISTS `GuardarComponentePorActivoFijo`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GuardarComponentePorActivoFijo`(pcPadre VARCHAR(12), pcHijo VARCHAR(12),  pcUsuario VARCHAR(30),pcEstado CHAR(1)) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN	

	DECLARE lnCantidadComponenteActivoFijo INT(2) DEFAULT 0;	
	
	/*************************************************
		VERIFICO SI EL COMPONENTE DE ACTIVO FIJO EXISTE
	*************************************************/
	SET lnCantidadComponenteActivoFijo = (SELECT COUNT(0) FROM af_activoscomponentes WHERE accm_padre = pcPadre AND accm_hijo = pcHijo); 
	
	IF lnCantidadComponenteActivoFijo = 0 THEN

			/*************************************************
				EL COMPONENTE DEL ACTIVO FIJO NO EXISTE. ENTONCES INSERTO EL REGISTRO
			*************************************************/	

			INSERT INTO af_activoscomponentes (accm_padre,
									accm_hijo,
									accm_usrcreacion,
									accm_fcreacion,
									accm_estado)
	...
	ELSE
			/*************************************************
				EL COMPONENTE DEL ACTIVO EXISTE. ENTONCES ACTUALIZO
			*************************************************/
			UPDATE af_activoscomponentes
				SET accm_padre = pcPadre,
						accm_hijo = pcHijo,
						accm_estado = pcEstado
			WHERE
				accm_padre = pcPadre AND accm_hijo = pcHijo;
	END IF;
...
-- ----------------------------
-- Function structure for GuardarGrupo
-- ----------------------------
DROP FUNCTION IF EXISTS `GuardarGrupo`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GuardarGrupo`(pcCodigo CHAR(3), pcCategoria CHAR(3), pcNombre VARCHAR(60), pcUsuario VARCHAR(30), pcEstado CHAR(1)) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN	

	DECLARE lnCantidadGrupo INT(2) DEFAULT 0;	
	DECLARE lnConsecutivo INT(12) DEFAULT 0;
	DECLARE lcConsecutivo CHAR(3) DEFAULT '';
	
	/* ************************************************
		VERIFICO SI EL CODIGO DE GRUPO RECIBIDO EXISTE
	*************************************************/
	SET lnCantidadGrupo = (SELECT COUNT(0) FROM af_grupos WHERE grup_codigo = pcCodigo);	
	
	IF lnCantidadGrupo = 0 THEN
			/*************************************************
				EL GRUPO NO EXISTE. ENTONCES TOMO EL CONSECUTIVO
				E INSERTO EL REGISTRO
			*************************************************/			
			SET lnConsecutivo = (SELECT ObtenerConsecutivo('009'));

			SET lcConsecutivo = (SELECT LPAD(CONVERT(lnConsecutivo, CHAR(3)),3, '0'));

			INSERT INTO af_grupos (grup_codigo,
									grup_categoria,
									grup_nombres,
									grup_usrcreacion,
									grup_fcreacion,
	...
	ELSE
			/*************************************************
				EL GRUPO EXISTE. ENTONCES ACTUALIZO
			*************************************************/
			UPDATE af_grupos
					SET grup_categoria = pcCategoria, 
							grup_nombres = pcNombre, grup_estado = pcEstado
			WHERE
				grup_codigo = pcCodigo;
	END IF;
...
-- ----------------------------
-- Function structure for ObtenerNombreActivoFijo
-- ----------------------------
DROP FUNCTION IF EXISTS `ObtenerNombreActivoFijo`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `ObtenerNombreActivoFijo`(pcCodigo VARCHAR(12)) RETURNS varchar(200) CHARSET latin1 COLLATE latin1_spanish_ci
    READS SQL DATA
    DETERMINISTIC
BEGIN	
	...
	SET lcNombre = (SELECT 
										CONCAT_WS(" ",grup_nombres,subg_nombres, marc_nombre, IFNULL(acti_cantpresentacion,''), pres_abrevia, IFNULL(acti_modelo,''))
									FROM
										af_activos
									INNER JOIN
										af_subgrupos ON subg_codigo = acti_subgrupo
